...
; use-for-one-hour
; this method assumes users enter a candle height where 0.0 <= candle height and candle height >= 1.0 to produce a positive height difference result
...
(test (use-for-one-hour (candle 0.9)) (candle 0.0))
